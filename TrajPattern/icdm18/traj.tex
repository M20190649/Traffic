...
\begin{document}
% Title portion
\title{Understanding Human Mobility Productivity \\ Trajectory Pattern Mining on Multi-source Data}
\title{Evaluating Human Productivity }
\title{Discovering Patterns of Individual Efficiency \\ from Multi-source Data}

\author{\IEEEauthorblockN{Hui Zhang\IEEEauthorrefmark{2},
Renjun Hu\IEEEauthorrefmark{2},
Haochao Ying\IEEEauthorrefmark{4},
...
\IEEEauthorblockA{\IEEEauthorrefmark{4}Zhejiang University, Hangzhou, China}
\IEEEauthorblockA{\IEEEauthorrefmark{3}Rutgers University, USA}
\{zhanghui, hurenjun, mashuai, huaijp\}@buaa.edu.cn \hspace{2ex} haochaoying@zju.edu.cn \hspace{2ex} hxiong@rutgers.edu}}
