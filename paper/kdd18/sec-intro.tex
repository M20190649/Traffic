...
\item numerous traffic conditions that can cause traffic congestion e.g., recurring (e.g., daily rush hours), occasional (e.g., rainy day), unpredictable (e.g., accidents), and temporarily congestions (e.g., a basketball game)~\cite{MTL2017ICDM}.
\ei
