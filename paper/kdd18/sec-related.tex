...
\stitle{Others}. It is well known that more than 80\% of the traffic in a typical city runs on only 10\% to 20\% of the roads hence the trajectory data are expected to be sparse~\cite{WuMSZZCWKDD16}.
