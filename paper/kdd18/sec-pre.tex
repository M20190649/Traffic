...
\begin{definition}[Road Network]A road network is a directed graph $G(V, E)$ where $V$ denotes the set of road intersections or road ends, and $E\subseteq V\times V$ denotes the set of road segments. A directed edge $(s, t)\in E$ %connecting nodes $s$ and $t$
